                    ...
                    <div className={styles.container}>
                        <div className={styles.block}>
                            ...
                            <div className={styles.position}>
                                ...
                                <ul className={styles.position_bullets}>
                                    <li>
                                        Lead front-end developer of the new website for popular
                                        Polish supplements brand. <br />
                                        See it in action on{' '}
                                        <a
                                            href="https://healthla.bs/new"
                                            target="_blank"
                                    ...
                                    <li>
                                        Modern VueJS progressive e-commerce application with
                                        headless Magento as a backend.
                                        <br /> Written from scratch, fully in TypeScript with
                                        ESLint.
                                    </li>
                                    <li>
                                        All content is statically generated and served through CDN.
                                        Used NuxtJS for SSR / isomorphic rendering.
                                    </li>
                                    <li>
                                        Very performant, responsive & highly optimized for SEO.
                        ...
                        <div className={styles.block}>
                            ...
                            <div className={styles.position}>
                                ...
                                <ul className={styles.position_bullets}>
                                    <li>
                                        Working in an international team (all continents) spread
                                        across multiple timezones (up to 10h delay).
                                    </li>
                                    <li>
                                        Created an internal component library designed to allow
                                        backend developers to easily create views. <br />
                                        This allowed for 2 or 3 developers to handle the whole
                                        company frontend for several years. <br />
                                        Still powering most of company applications.
                                    </li>
                                    <li>
                                        Architect of most of the applications currently in use by
                                        the company, including management app, client portal,
                                        internal backoffice app, and public API. All of them were
                                        rewritten from old ones.
                                    </li>
                                    <li>Company's lead front-end developer & architect.</li>
                                    <li>
                                        Driven the transition to newer technologies & approaches,
                                        like using VueJS for the frontend, or designing CQS-based
                                        API.
                                    </li>
                                    <li>
                                        Architect & lead developer of multiple new businness
                                        modules, mostly regarding training & facility booking.
                                    </li>
                                    <li>
                        ...
                        <div className={styles.block}>
                            ...
                            <div className={styles.position}>
                                ...
                                <p className={styles.position_time}>
                        ...
                        <div className={styles.block}>
                            ...
                            <div className={styles.position}>
                                ...
                                <h4 className={styles.position_company}>
                ...
                <div className={styles.subsection}>
                    ...
                    <div className={styles.container}>
                        <div className={styles.education}>
                            <h2 className={styles.education_header}>
